...
hl.config({
	...
	decoration = {
		...
		-- Window transparency configurations
		active_opacity = 1.0,
	...
	dwindle = {
		preserve_split = true, -- Retains split orientation when shifting windows
	},

	master = {
		new_status = "master", -- Sets new windows as the master target
	},
