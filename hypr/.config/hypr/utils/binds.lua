...
local cmd = hypr.scripts.commands
...
M.keybinds = {
	...
	-- ---------------------------------------------------------------------
	{ mod, "Return", hl.dsp.exec_cmd(cmd.terminal), { description = "Terminal" } },
	...
	-- ---------------------------------------------------------------------
	{ mod .. " + CTRL", "SPACE", hl.dsp.exec_cmd(cmd.waybar_toggle), { description = "Toggle Waybar" } },
	{ mod .. " + CTRL", "E", hl.dsp.exec_cmd(cmd.file_manager), { description = "Open File Manager" } },
	{ mod .. " + CTRL", "A", hl.dsp.exec_cmd(cmd.mixer), { description = "Open Audio Mixer" } },
	{ mod .. " + CTRL", "B", hl.dsp.exec_cmd(cmd.bluetooth), { description = "Open Bluetooth Settings" } },
	{ mod .. " + CTRL", "W", hl.dsp.exec_cmd(cmd.wifi), { description = "Open Wifi Settings" } },
	{ mod .. " + CTRL", "C", hl.dsp.exec_cmd(cmd.system_monitors), { description = "Open System Monitors" } },
	{ mod, "B", hl.dsp.exec_cmd(cmd.browser), { description = "Open Web Browser" } },
	{ mod, "SPACE", hl.dsp.exec_cmd("uwsm-app -- vicinae toggle"), { description = "Toggle App Launcher" } },
